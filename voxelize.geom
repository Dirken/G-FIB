...
void main( void )
{
	...
	emitCara(v1, v2, v3, v4, vfrontColor[gl_PrimitiveIDIn]);
	emitCara(v5, v6, v7, v8, vfrontColor[gl_PrimitiveIDIn]);
	emitCara(v1, v3, v5, v7, vfrontColor[gl_PrimitiveIDIn]);
	emitCara(v2, v4, v6, v8, vfrontColor[gl_PrimitiveIDIn]);
	emitCara(v1, v2, v5, v6, vfrontColor[gl_PrimitiveIDIn]);
	emitCara(v2, v3, v7, v8, vfrontColor[gl_PrimitiveIDIn]);
}
